...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('[extract-job] HANDLER INVOKED, method =', req.method);
      ...
      : `Extract job details from this URL: ${url}. If you cannot access it, return a template with:
{
  ...
  "requirements": []
    ...
    console.log('[extract-job] Calling Gemini...');
    ...
    console.log('[extract-job] Gemini response length:', text.length);
