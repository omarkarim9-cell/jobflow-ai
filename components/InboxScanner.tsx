...
import { Job, JobStatus, EmailAccount, UserPreferences, isSubscriptionValid, UserProfile } from '../types.ts';
import { Mail, Search, Trash2, AlertCircle, Settings, RefreshCw, Calendar, Link, X, Loader2, StopCircle } from 'lucide-react';
import { extractJobsFromEmailHtml } from '../services/geminiService.ts';
import { localExtractJobs } from '../services/localAiService'; // Direct Import
import { listMessages, getMessageBody, decodeEmailBody } from '../services/gmailService.ts';
import { NotificationType } from './NotificationToast.tsx';
import { EmailConnectModal } from './EmailConnectModal.tsx';
